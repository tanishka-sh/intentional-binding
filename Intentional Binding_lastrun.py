...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Tanishka\\OneDrive\\Documents\\2. Courses\\PSY310\\Experiments\\T6 Intentional Binding\\Intentional Binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    fixation_ = visual.ShapeStim(
        win=win, name='fixation_',
        size=(0.2, 0.2), vertices='circle',
        ori=0.0, pos=(0, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='green', fillColor='green',
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and beep of the sound 0-999 ms. Click submit after entering the value. ',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, fixation_, key_resp],
        )
        ...
        while continueRoutine:
            ...
            # if fixation_ is starting this frame...
            if fixation_.status == NOT_STARTED and tThisFlip >= 0.1-frameTolerance:
                # keep track of start time/frame for later
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'fixation_.started')
                # update status
                fixation_.status = STARTED
                fixation_.setAutoDraw(True)
            
            # if fixation_ is active this frame...
        ...
        response = data.Routine(
            name='response',
            components=[text, textbox, mouse, button],
        )
